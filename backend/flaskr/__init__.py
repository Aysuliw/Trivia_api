...
def create_app(test_config=None):
  ...
  '''
    # endpoint to delete question by given id
  ...
  '''
    # search questions by given search String
    @app.route('/questions/search', methods=['POST'])
    def search_questions():
        body = request.get_json()
        search_term = body.get('searchTerm', None)

        # if search string is empty return 404 error
        if(search_term == ''):
            abort(404)
        else:
  ...
  '''
    # endpoiint to get questions by their category
    ...
    def get_questions_by_category(category_id):
        ...
        return jsonify({
            'success': True,
            'questions':
            [questions.format() for questions in questions_by_category],
  ...
  '''
    ...
    def questions_for_quiz():
        ...
        try:
            ...
            # check if quiz_category is ALL or other category
            if quiz_category == 0:
                questions = Question.query.filter(
